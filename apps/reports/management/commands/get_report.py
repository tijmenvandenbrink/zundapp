...
def get_client_sessions():
    ...
    for session in r.json()['mgmtResponse']['reportDataDTO']['dataRows']['dataRow']:
        ...
        cs = ClientSession.create(client_username=data['clientUsername'],
                                  ...
                                  avg_session_throughput=data['throughput'].translate(None, '< '),
                                  ...
                                  anchor_controller=data['anchorControllerIpAddress'].translate(None, ' '),
