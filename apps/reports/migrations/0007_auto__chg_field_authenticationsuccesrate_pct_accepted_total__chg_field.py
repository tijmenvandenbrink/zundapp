...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AuthenticationSuccesRate.pct_accepted_total'
        db.alter_column(u'reports_authenticationsuccesrate', 'pct_accepted_total', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'AuthenticationSuccesRate.pct_accepted_clean'
        db.alter_column(u'reports_authenticationsuccesrate', 'pct_accepted_clean', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'AuthenticationSuccesRate.pct_accepted_total'
        db.alter_column(u'reports_authenticationsuccesrate', 'pct_accepted_total', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=5, decimal_places=2))

        # Changing field 'AuthenticationSuccesRate.pct_accepted_clean'
        db.alter_column(u'reports_authenticationsuccesrate', 'pct_accepted_clean', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=5, decimal_places=2))
    ...
    models = {
        ...
        u'reports.authenticationsuccesrate': {
            ...
            'pct_accepted_clean': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
            'pct_accepted_total': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {})
        },
