...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccessPointLoad.snr_mean'
        db.add_column(u'reports_accesspointload', 'snr_mean',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AccessPointLoad.snr_std'
        db.add_column(u'reports_accesspointload', 'snr_std',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AccessPointLoad.snr_var'
        db.add_column(u'reports_accesspointload', 'snr_var',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AccessPointLoad.rssi_mean'
        db.add_column(u'reports_accesspointload', 'rssi_mean',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AccessPointLoad.rssi_std'
        db.add_column(u'reports_accesspointload', 'rssi_std',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AccessPointLoad.rssi_var'
        db.add_column(u'reports_accesspointload', 'rssi_var',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'AccessPointLoad.bandwidth_available'
        db.alter_column(u'reports_accesspointload', 'bandwidth_available', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'AccessPointLoad.snr_mean'
        db.delete_column(u'reports_accesspointload', 'snr_mean')

        # Deleting field 'AccessPointLoad.snr_std'
        db.delete_column(u'reports_accesspointload', 'snr_std')

        # Deleting field 'AccessPointLoad.snr_var'
        db.delete_column(u'reports_accesspointload', 'snr_var')

        # Deleting field 'AccessPointLoad.rssi_mean'
        db.delete_column(u'reports_accesspointload', 'rssi_mean')

        # Deleting field 'AccessPointLoad.rssi_std'
        db.delete_column(u'reports_accesspointload', 'rssi_std')

        # Deleting field 'AccessPointLoad.rssi_var'
        db.delete_column(u'reports_accesspointload', 'rssi_var')


        # Changing field 'AccessPointLoad.bandwidth_available'
        db.alter_column(u'reports_accesspointload', 'bandwidth_available', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=1))
