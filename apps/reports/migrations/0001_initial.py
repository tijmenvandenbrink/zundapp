...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reports_clientsession', (
            ...
            ('vendor', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ...
            ('profile', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ...
            ('policy_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('avg_session_throughput', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=1)),
            ('host_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('client_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('global_unique', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('local_unique', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('link_local', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True, blank=True)),
            ('speed', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('ccx', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ...
            ('anchor_controller', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True, blank=True)),
            ...
            ('encryption_cipher', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('eap_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('authentication_algorithm', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('web_security', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ...
            ('e2e', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('data_retries', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('rts_retries', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('mobility_status', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('network_access_id', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('pmip_state', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('connected_interface', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('home_address', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('access_technology_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('local_link_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('lma', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
